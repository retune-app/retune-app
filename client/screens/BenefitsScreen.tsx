...
export default function BenefitsScreen() {
  ...
  const sections: BenefitSectionProps[] = [
    ...
    },
    {
      ...
      description: "Controlled breathing activates your parasympathetic nervous system, reducing stress and anxiety. Rewired offers guided techniques like Box Breathing, 4-7-8, and Coherent Breathing—each designed to calm your mind and prepare you for deeper reflection.",
    },
    {
      icon: "repeat",
      iconColor: "#8B5CF6",
    ...
    },
    {
      ...
      description: "Every visual element in Rewired is crafted to support your mental wellbeing:",
      bullets: [
    ...
    <View style={[styles.container, { backgroundColor: theme.backgroundSecondary }]}>
      ...
      >
        <View style={[styles.heroSection, { backgroundColor: theme.primary + "15" }]}>
          ...
          <ThemedText type="h4" style={styles.heroTitle}>Why Rewired Works</ThemedText>
        ...
        <View style={[styles.footerCard, { backgroundColor: theme.cardBackground }]}>
          ...
          <ThemedText type="small" style={[styles.footerText, { color: theme.textSecondary }]}>
            With consistent practice, you'll notice shifts in your thinking patterns, improved emotional resilience, and a stronger sense of self. Rewired is your companion on this transformative journey.
          </ThemedText>
        </View>
      </ScrollView>
    </View>
