...
- **Breathing Mode**: Offers various breathing techniques (Box, 4-7-8, Coherent, Energizing) with animated visuals, duration selection, binaural beats, and optional science-based technique tips (toggle in settings).
- **AI Daily Greetings**: Personalized empowering sub-messages generated by OpenAI, cached daily per user, with time-of-day context. Endpoint: `GET /api/daily-greeting?timeOfDay=morning|afternoon|evening|night`.
