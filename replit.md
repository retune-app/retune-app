...
## Recent Changes (v1.7 Build 2 — February 15, 2026)
...
- **Production Static Bundle Rebuild**: New production bundle (build `1771188736611-7782`) deployed with always-visible Google Sign-In and OTA update config.
