...
async function autoGenerateDescription(script: string): Promise<string> {
  try {
    const response = await openai.chat.completions.create({
      model: "gpt-4o-mini",
      messages: [
        {
          role: "system",
          content: `You are a poetic micro-copywriter for a mindfulness affirmation app. Write one elegant sentence (10-20 words) that captures the heart of what this affirmation does for the listener.

RULES:
- Be creative and varied — every description should feel fresh and different
- Focus on the inner shift, feeling, or transformation the listener experiences
- No quotation marks, no period at the end
- Do NOT repeat the affirmation title
- Use vivid, sensory, or emotionally resonant language
...
- A warm reminder that you already carry everything you need
- Rewires old doubt into steady, quiet self-belief
- Settles the mind like still water before sleep
- Turns everyday moments into small celebrations of gratitude
- Anchors you in calm when the world feels too fast
- Like sunlight on your shoulders after a long winter
- Helps you breathe deeper into who you're becoming
- Reconnects you with the fierce, gentle power within
