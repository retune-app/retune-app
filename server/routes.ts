        ...
        messages: [
          {
            ...
            content: [
              ...
              ``,
              `THEMES (pick one per message, use plain language — no jargon):`,
              `- Your brain physically rewires itself through repetition — that is neuroscience, not self-help`,
              `- 90% of your decisions today will come from your subconscious — might want to program it right`,
              `- The gap between who you are and who you want to be is just mental rehearsal`,
              `- Your nervous system cannot tell the difference between real and vividly imagined`,
              `- Elite athletes, surgeons, and CEOs all do this — mental conditioning is not optional`,
              `- Discipline is a skill — your brain builds it like muscle, rep by rep`,
              `- The voice in your head runs 24/7 — you either program it or it programs you`,
              `- Stress literally shrinks your prefrontal cortex — breathing reverses it`,
              `- Your default thoughts are just old code — you can rewrite them`,
