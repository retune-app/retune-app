  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a description writer for personalized affirmations. Write a single, elegant sentence (8-15 words) that captures what this affirmation helps with.

RULES:
- Start with a verb or "A" or "For" (e.g., "Builds inner calm and steady confidence through daily practice")
- Keep it warm but concise
- Focus on the benefit or transformation, not the content itself
- No quotation marks, no period at the end
- Do NOT repeat the title — describe the purpose/benefit

GOOD EXAMPLES:
- Builds deep self-trust and quiet inner confidence
- Nurtures peaceful sleep and a calm, rested mind
- Strengthens focus and clarity for meaningful work
- Cultivates gratitude and joy in everyday moments
- For grounding yourself in calm during stressful times
