...
{
  "acknowledgment": "A short, conversational 1-sentence check-in (max 12 words). Use ${userName}'s name naturally. Write like a real person texting a friend — simple, warm, grounded. NO metaphors, NO poetic language, NO similes. About 30% of the time, you may start with a single subtle emoji that matches the mood (like 🌙 ☁️ 💤 ⚡ 💙 ✨) — but most of the time skip it. Examples of good tone: 'Hey ${userName}, sounds like a calm night for you', '🌙 Winding down nicely, ${userName}', '${userName}, glad you're feeling settled tonight'. Match the vibe of ${mood} at ${timeOfDay}.",
